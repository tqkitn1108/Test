function SuggestItem({ handleClickSuggestion, searchSuggestion }) {
  return (
    <div className="text-black p-[12px] flex gap-[10px] border-b border-[#5a55552e] cursor-pointer" onClick={() => handleClickSuggestion(searchSuggestion.name, searchSuggestion.id)}>
      <div className="h-[26px] w-[24px]">
        {searchSuggestion.id ?
      ...
      <div className="font-bold text-[14px] flex items-center">{searchSuggestion.name}</div>
    </div>
  )
}
