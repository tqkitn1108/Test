    ...
    <div className="flex justify-center items-center h-full">
      <div className="bg-white my-5 mx-auto rounded-lg max-w-md shadow-lg">
        <div className="p-5 w-full flex flex-col">
          ...
          <div className="flex justify-center">
            <a
              className="btn w-full py-2 text-white bg-red-600 rounded flex justify-center items-center"
              href="#"
            >
          ...
          <div className="flex justify-center mt-3">
            <a
              className="btn w-full py-2 text-white bg-blue-700 rounded flex justify-center items-center"
              href="#"
            >
              <FontAwesomeIcon icon={faFacebook} className="mr-2" /> Sign
              in with Facebook
            </a>
          </div>
